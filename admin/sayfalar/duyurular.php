  ...
  <div class="row">
    <div class="col-xl-12 col-sm-6 mb-3">
      ...
      while ($duyurugoster = $verial1 -> fetch(PDO::FETCH_ASSOC)){
        echo '
        <div class="alert alert-warning"><i class="fas fa-fw fa-bullhorn"></i> '.$duyurugoster['baslik'].' - Duyuru : '.$duyurugoster['icerik'].'
          <div class="btn-group float-right">
            <a href="?sayfa=duyurugoruntule&id='.$duyurugoster['id'].'" class="btn btn-warning btn-sm"><i class="fas fa-edit"> Düzenle</i></a>
            <a href="?sayfa=duyurular&id='.$duyurugoster['id'].'" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"> Sil</i></a>
          </div>
        </div>
        ';
      }
