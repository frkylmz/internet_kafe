...
if(isset($_POST['Gonder']))
{
  ...
  $stmt = $conn->prepare('INSERT INTO yemekler(urunbaslik, ekleyen) VALUES (:urunbaslik, :ekleyen)');
  ...
  if($stmt){
    ...
    <strong>Yemek Eklendi!</strong>
    </div>';
  }else{
    $mesaj = '<div class="alert alert-dismissible alert-danger">
    <button type="button" class="close" data-dismiss="alert">×</button>
    <strong>Yemek Ekleme Başarısız!</strong>
    </div>';
  }
}
?>
  ...
  <form action="" method="post" enctype="multipart/form-data">
    <div class="row">
      <div class="col-xl-12 col-sm-12 mb-3">
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" name="urunbaslik" class="form-control" placeholder="Yemek İsmi - Yemek Fiyatı Giriniz">
        </div>  
		</div>
    ...
    <!-- <div class="col-xl-8 col-sm-12 mb-3"> 
        <div class="input-group mb-3">
          ...
          <input type="text" name="fiyat" class="form-control" placeholder="Yemek Fiyatı">
        </div>  
		</div> -->
