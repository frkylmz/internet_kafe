...
<?php 
$vericek = $conn -> prepare("SELECT * FROM yemekler where id = :id");
...
if (isset($_POST["Gonder"])) {
  ...
  $fiyat = $_POST['fiyat'];   
  $guncelle = $conn -> prepare("UPDATE yemekler SET urunbaslik=:urunbaslik WHERE id=:id");
  // $guncelle = $conn -> prepare("UPDATE yemekler SET fiyat=:fiyat WHERE id=:id");
  $guncelle->bindParam(':id', $ids);
  $guncelle->bindParam(':urunbaslik', $urunbaslik); 
  // $guncelle->bindParam(':fiyat', $fiyat); 
  $guncelle-> execute(); 
  if($guncelle){
    $mesaj = '<meta http-equiv="refresh" content="2;URL=?sayfa=yemekler">
...
if (isset($_GET['numaram'])) {
  ...
  $urunsil = $conn -> prepare("DELETE FROM yemekler where id = :id");
  ...
  if($urunsil){
    ...
    <div class="alert alert-dismissible alert-success">
    <button type="button" class="close" data-dismiss="alert">×</button>
    <strong>Yemek Başarı İle Silindi! 2 Saniye İçinde Yönlendiriliyorsunuz!</strong>
    </div>';
  }else{
...
<div class="container-fluid">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="?sayfa=yemekler">Yemek Düzenle</a></li>
    ...
    <div class="row">
      ...
      <div class="col-xl-8 col-sm-12 mb-3">        
        <div class="input-group mb-3">
          <div class="input-group-prepend"><span class="input-group-text">Yemek İsmi - Yemek Fiyatı</span></div>
      ...
      <!-- <div class="col-xl-8 col-sm-12 mb-3">        
        <div class="input-group mb-3">
          <div class="input-group-prepend"><span class="input-group-text">Yemek Fiyatı</span></div>
      ...
      <div class="col-xl-12 col-sm-12 mb-3">
        <hr>
        <a href="?sayfa=yemekler" class="btn btn-danger pull-left">Geri Dön</a>
