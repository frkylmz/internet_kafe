...
if (isset($_GET['id'])) {
  $numaras = $_GET['id']; 
  $sil = $conn -> prepare("DELETE FROM yemekler where id = :id");
...
<div class="row">
  <div class="col-xl-12 col-sm-6 mb-3">
    ...
    <div class="alert alert-info">
      ...
      echo 'Sistemde <b>'.$say.'</b> adet yemek bulunmaktadır. Alfabetik olarak listelenir.';
      ?>
      <a class="btn-success btn-sm float-right mb-3" href="?sayfa=yemekekle">Yemek Ekle</a>
    </div>
  </div>
  ...
  <?php
  $verial1 = $conn -> prepare("SELECT * FROM yemekler ORDER BY urunbaslik");
  $verial1-> execute();
    ...
    <div class="col-xl-4 col-sm-12 mb-3">
      <article class="pKart">    
        ...
        <div class="pKonuBilgi">
          <div class="pDetay">
            <ul class="pBilgi">
              <li><a href="?sayfa=yemekler&id='.$urungoster['id'].'" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i> Sil</a></li>
              <li><a href="?sayfa=yemekduzenle&id='.$urungoster['id'].'" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Düzenle</a></li>
            </ul>
          </div>
        </div>
      </article>
