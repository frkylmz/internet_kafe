...
<?php 
$vericek = $conn -> prepare("SELECT * FROM gorevler where id = :id");
...
if (isset($_POST["Gonder"])) {
  ...
  $guncelle = $conn -> prepare("UPDATE gorevler SET urunbaslik=:urunbaslik WHERE id=:id");
...
if (isset($_GET['numaram'])) {
  ...
  $urunsil = $conn -> prepare("DELETE FROM gorevler where id = :id");
  ...
  if($urunsil){
    ...
    <div class="alert alert-dismissible alert-success">
    <button type="button" class="close" data-dismiss="alert">×</button>
    <strong>Görev Başarı İle Silindi! 2 Saniye İçinde Yönlendiriliyorsunuz!</strong>
    </div>';
  }else{
...
<div class="container-fluid">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="?sayfa=gorevler">Görev Düzenle</a></li>
