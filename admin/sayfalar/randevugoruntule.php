      ...
      <form method="post" action="">
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            <div>
              <strong>Adı Soyadı:</strong> <?php echo $veriyigoster['adsoyad']; ?>
            </div> 

            <div>
              <strong>Telefon:</strong> <?php echo $veriyigoster['telefon']; ?>
            </div>

            <div>
              <strong>Hizmet - Hizmet Fiyatı:</strong> <?php echo $veriyigoster['hizmet']; ?>
            </div>

            <div>
              <strong>Tarih:</strong> <?php echo $veriyigoster['randevu_tarihi']; ?>
            </div>

            <div>
              <strong>Saat:</strong> <?php echo $veriyigoster['randevu_saati'] ?>
            </div>
          </div>
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              <strong>Açıklama:</strong> <?php echo $veriyigoster['aciklama']; ?>
            </p>
          </div>
        </div>
        ...
        <?php if($veriyigoster["durum"]==1) {?>        
          ...
          <div class="row">
            <div class="col-xs-12 col-md-12 form-group">
              <a href="?sayfa=randevular" class="btn btn-danger btn-sm pull-left">Geri Dön</a>
